...
public class StandardCalculatorTest {
    ...
    void testAdditionOverflowForDoubles(){
        ...
        Assertions.assertThrows(ArithmeticException.class,new Executable(){
            ...
            public void execute() throws Throwable{
                ...
                Assertions.assertEquals("Double overflow", actualResult);
        ...
        void testMultiplicationOverflowForDoubles(){
            ...
            Assertions.assertThrows(ArithmeticException.class,new Executable(){
                ...
                public void execute() throws Throwable{
                    ...
                    standardCalculator.multiply(Double.MAX_VALUE, Double.NEGATIVE_INFINITY);
                    standardCalculator.multiply(Double.MAX_VALUE, Double.POSITIVE_INFINITY);
                    double actualResult = standardCalculator.getResult();
                    Assertions.assertEquals("Double overflow", actualResult);
    ...
    @Test
    @DisplayName("Test Addition of Two double")
    void testAdditionOperationDouble(){
        standardCalculator.add(1.0,1.0);
        double actualResult = standardCalculator.getResult();
        Assertions.assertEquals(2.0, actualResult);
    }

    @Test
    @DisplayName("Test Substraction of Two double")
    void testSubtractionOperationDouble(){
        standardCalculator.subtract(1.0,1.0);
        double actualResult = standardCalculator.getResult();
    ...
    void testDivisionOperationDouble(){
        standardCalculator.divide(2.0,1.0);
        double actualResult = standardCalculator.getResult();
        Assertions.assertEquals(2.0, actualResult);
    }
